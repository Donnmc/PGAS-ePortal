...
namespace ePortal.WebAPI.Controllers
{
    ...
    public class v_emergency_hotlineController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<v_emergency_hotlineDTO>>> GetEmergencyHotline()
        {
            ...
            var mappedHotelineDirectory = directory
                ...
                .Select(office => new v_emergency_hotlineDTO
                {
                    //office
                    ...
                    .Select(line => new v_emergency_hotlineLineDTO
                    {
                        ...
                        .Select(hotline => new v_emergency_hotlineAreaDTO
                        {
                            //hotline
